...
SECRET_KEY = 'django-insecure-hy_bgn!3mk4s6s(xms$h@gf2k09j@udy)ol6_tv9v#bb-)i9e2'
...
cloudinary.config( 
  cloud_name = "dgfhrylja",  
  api_key = "673493512936763", 
  api_secret = "6wk_6WD9u_QsPT2EsnLRoEef2SQ",
  secure = True
)
